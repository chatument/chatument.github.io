    ...
    <div className="mx-auto container mt-8 pl-20 pr-20 pt-8 grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-16 ">
      <article className="flex max-w-xl flex-col items-start justify-between">
        <div className="group relative">
          <h1 className="mt-3 text-2xl font-semibold leading-6 text-gray-800 group-hover:text-gray-500 text-center">
      ...
      <article className="flex max-w-xl flex-col items-start justify-between">
        <div className="group relative">
          <h1 className="mt-3 text-2xl font-semibold text-gray-800 group-hover:text-gray-500 text-center">
